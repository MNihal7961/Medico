        ...
        <div className='md:col-span-2'>
          <div className="flex items-center gap-5 ">
            <figure className='max-w-[200px] max-h-[200px]'>
              <img src={doctorImg} alt="docImg" className='w-full' />
            </figure>
            <div>
              ...
              <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Nihal m</h3>
              <div className="flex items-center gap-[6px] ">
                <span className="flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
                  <img src={starIcon} alt="star" /> 4.6
                </span>
                <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor'>(272)</span>
              </div>
              <p className='text__para text-[14px] md:text-[15px] leading-6 lg:max-w-[390px]'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus, soluta?</p>
            </div>
          </div>
